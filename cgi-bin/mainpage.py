...
<link rel="stylesheet" type="text/css" href="../media/indexpage.css" />
</head>
<body>
'''
body = """ """
...
f = open("../media/fooddata.txt", "r")
#f = open("/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/fooddata.txt", "r")
data = f.read() 
f.close() 



f1 = open("/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/favorites.txt", "r")
thefavoritesread = f1.read()
f1.close()


f3 = open("/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/loggedin.txt", "r")
users = f3.read()
users = users.split("\n")
if '' in users:
	users.remove('')
if os.stat("/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/loggedin.txt").st_size != 0:
...
<img src="../images/tribecastuy.jpg" style="display: block;margin: 0 auto; width: 75%; height: 500px; border: 3px solid darkgrey">
<form method="GET" action="mainpage.py" style="text-align:center;">
...
def authenticate(u,ID,IP):
	loggedIn = open('/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/users.txt','r').read().split('\n')

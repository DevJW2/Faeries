...
def authenticate(u,p):
    users = open('/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/users.txt','r').read().split('\n')
...
if 'username' in form and 'password' in form:
    ...
    if authenticate(username,password):
        ...
        #write to a file
        writeOrReplace('/Users/jeffreyweng/Documents/introcs2FinalProject/StuyCompsci/data/loggedin.txt',username,ID,IP)
